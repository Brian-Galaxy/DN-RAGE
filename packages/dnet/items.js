...
items.itemList = [
    ...
    ["Электронные часы \"IFruit\"", "", 0, 1169295068, 190, 110], //7
    ...
    ["Слот", "", 0, 9168982, 650, 2800], // 45
    ["Слот", "", 0, 9168982, 650, 3800], //46
    ...
    ["Сырое мясо тунца", "", 0, 936464539, 1000, 3000], //223
    ["Сырое мясо окуня", "", 0, 936464539, 300, 800], //224
    ["Сырое мясо краба", "", 0, 936464539, 600, 4000], //225
    ["Сырое мясо лосося", "", 0, 936464539, 290, 1000], //226
    ["Сырое мясо креветок", "", 0, 936464539, 290, 600], //227
    ["Сырое мясо рыбы", "", 0, 936464539, 300, 800], //228
    ["Сырое мясо рыбы", "", 0, 936464539, 300, 800], //229
    ["Сырое мясо рыбы", "", 0, 936464539, 300, 800], //230
    ["Сырое мясо рыбы", "", 0, 936464539, 300, 800], //231

    ["Мясо тунца", "", 0, 936464539, 1000, 3000], //232
    ["Мясо окуня", "", 0, 936464539, 300, 800], //233
    ["Мясо краба", "", 0, 936464539, 600, 4000], //234
    ["Мясо лосося", "", 0, 936464539, 290, 1000], //235
    ["Мясо креветок", "", 0, 936464539, 290, 600], //236
    ["Мясо рыбы", "", 0, 936464539, 300, 800], //237
    ["Мясо рыбы", "", 0, 936464539, 300, 800], //238
    ["Мясо рыбы", "", 0, 936464539, 300, 800], //239
    ["Мясо рыбы", "", 0, 936464539, 300, 800], //240

    ["Слот", "", 0, 936464539, 1000, 3000], //241
    ["Слот", "", 0, 936464539, 300, 800], //242
    ["Слот", "", 0, 936464539, 600, 4000], //243
    ["Слот", "", 0, 936464539, 290, 1000], //244
    ["Слот", "", 0, 936464539, 290, 600], //245
    ["Слот", "", 0, 936464539, 1000, 3000], //246
    ["Слот", "", 0, 936464539, 300, 800], //247
    ["Слот", "", 0, 936464539, 600, 4000], //248
    ["Слот", "", 0, 936464539, 290, 1000], //249
    ["Слот", "", 0, 936464539, 290, 600], //250
