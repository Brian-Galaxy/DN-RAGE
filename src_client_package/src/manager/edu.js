...
let shortPos = [
    ...
    [
        ...
        "info",
        "Вы сами выбираете какая будет у вас организация, будь то это мафия или же уличная банда - не важно, у нас нет никаких функциональных ограничений на это. Каждую ночь на сервере будет проходить война за грузы в которой сможет принять участия любая преступная организация. Содержимое фургонов очень разнообразное. Так же вас ожидает ограбление банков, магазинов, захват улиц для получения дохода и много всего интересного. На сервер введена криптовалюта e-coin которая является неотъемлемой частью всего криминала.",
    ...
    [
        "Погода",
        "info",
        "Временя года со своими особенностями, зимой оденьтесь потеплее, летом полегче. Сильные ветра, шторма от которых появляются огромные волны в океане. Поэтому не забывайте следить за прогнозом погоды.",
...
let longPos = [
    [
        "Добро пожаловать",
        "info",
        "Добро пожаловать на DEDNET, уникальный Role Play сервер, где вы точно будете удивлены вашими возможностями. Скорее всего у вас возникнет вопрос что же уникального у нас есть? Тогда нажимайте далее и начинайте знакомство с нашим сервером.",
    ...
    [
        "Организации",
        "info",
        "На сервере присутствую различные фракции в которые вы можете попасть: Полицейский департамент, Шериф департамент, Правительство, Скорая медицинская помощь, Редакторы новостей и конечно же различные банды и иные организации.",
    ...
    [
        "Правительство",
        "info",
        "Это здание правительства, именно тут вы будете получить ваши лицензии, так же правительство занимается финансированием государственных структур, разработкой законов и управление штатом San Andreas.",
        -1377.4583740234375, -592.527099609375, 60.33771514892578, //PosCam
        -1373.0677490234375, -503.034912109375, 53.26356506347656, //PosAt
    ],
    [
        "Больница",
        "info",
        "На проекте присутствуют 2 функционирующие больницы, если вам вдруг нужно пополнить ваше здоровье, то вы всегда сможете обратиться к врачам с такой просьбой.",
